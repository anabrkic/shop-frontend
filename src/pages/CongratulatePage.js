...
export const CongratulatePage = (props) => {
    return (
        <div className="d-flex flex-column align-items-center w-100" Style="font-family:Tahoma">
            ...
            <button type="submit" className="btn btn-dark w-20 mt-2" onClick={() => props.history.push('/')}>Nastavi kupnju</button>
        </div>
    )
}
